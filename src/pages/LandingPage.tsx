...
export const LandingPage = ({ onGetStarted }: { onGetStarted: () => void }) => {
  return (
    <div className="min-h-screen bg-theme-bg-light dark:bg-theme-bg-dark text-theme-text-primary-light dark:text-theme-text-primary-dark selection:bg-brand-primary/30 transition-colors duration-300">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 border-b border-theme-border-light dark:border-theme-border-dark bg-theme-bg-light/80 dark:bg-theme-bg-dark/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 font-bold text-2xl tracking-tight">
            <span className="italic font-black text-brand-primary text-2xl">AJ</span>
            <span className="font-bold text-theme-text-primary-light dark:text-theme-text-primary-dark">Ai Journal</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-theme-text-secondary-light dark:text-theme-text-secondary-dark">
            <a href="#features" className="hover:text-theme-text-primary-light dark:hover:text-theme-text-primary-dark transition-colors">Features</a>
            <a href="#demo" className="hover:text-theme-text-primary-light dark:hover:text-theme-text-primary-dark transition-colors">AI Demo</a>
            <a href="#pricing" className="hover:text-theme-text-primary-light dark:hover:text-theme-text-primary-dark transition-colors">Pricing</a>
          </div>
          <button 
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-8 text-theme-text-primary-light dark:text-theme-text-primary-dark">
            ...
            <p className="text-xl text-theme-text-secondary-light dark:text-theme-text-secondary-dark max-w-2xl mx-auto leading-relaxed">
      ...
      {/* AI Demo Section */}
      <section id="demo" className="py-24 px-6 bg-theme-surface-light/30 dark:bg-theme-surface-dark/30">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight text-theme-text-primary-light dark:text-theme-text-primary-dark">
              See the <span className="text-brand-primary">AI Intelligence</span> in Action
            </h2>
            <p className="text-lg text-theme-text-secondary-light dark:text-theme-text-secondary-dark leading-relaxed">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-theme-text-primary-light/80 dark:text-theme-text-primary-dark/80">{text}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="relative bg-theme-surface-light dark:bg-theme-surface-dark border border-theme-border-light dark:border-theme-border-dark rounded-[2rem] overflow-hidden shadow-2xl">
              <div className="p-6 border-b border-theme-border-light dark:border-theme-border-dark bg-theme-bg-light/50 dark:bg-theme-bg-dark/50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-sm text-theme-text-primary-light dark:text-theme-text-primary-dark">AJ Intelligence</p>
                    <p className="text-[10px] text-brand-primary uppercase tracking-widest font-black">Active Analysis</p>
                  </div>
                </div>
                <div className="flex gap-1.5">
                  <div className="w-2 h-2 rounded-full bg-theme-border-light dark:bg-theme-border-dark" />
                  <div className="w-2 h-2 rounded-full bg-theme-border-light dark:bg-theme-border-dark" />
                  <div className="w-2 h-2 rounded-full bg-theme-border-light dark:bg-theme-border-dark" />
                </div>
              </div>
      ...
      {/* Trust Stats */}
      <section className="py-20 border-y border-theme-border-light dark:border-theme-border-dark">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
          <div>
            <p className="text-4xl font-black text-theme-text-primary-light dark:text-theme-text-primary-dark mb-2">1.2M+</p>
            <p className="text-sm text-theme-text-secondary-light dark:text-theme-text-secondary-dark uppercase tracking-widest font-bold">Trades Analyzed</p>
          </div>
          <div>
            <p className="text-4xl font-black text-theme-text-primary-light dark:text-theme-text-primary-dark mb-2">85%</p>
            <p className="text-sm text-theme-text-secondary-light dark:text-theme-text-secondary-dark uppercase tracking-widest font-bold">Trader Retention</p>
          </div>
          <div>
            <p className="text-4xl font-black text-theme-text-primary-light dark:text-theme-text-primary-dark mb-2">24/7</p>
            <p className="text-sm text-theme-text-secondary-light dark:text-theme-text-secondary-dark uppercase tracking-widest font-bold">AI Monitoring</p>
          </div>
          <div>
            <p className="text-4xl font-black text-theme-text-primary-light dark:text-theme-text-primary-dark mb-2">4.9/5</p>
            <p className="text-sm text-theme-text-secondary-light dark:text-theme-text-secondary-dark uppercase tracking-widest font-bold">User Rating</p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-4xl font-bold text-theme-text-primary-light dark:text-theme-text-primary-dark">Everything you need to <span className="text-brand-primary">Master</span> your Mind</h2>
            <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark max-w-2xl mx-auto">Powerful tools designed for professional traders who take their psychology as seriously as their technicals.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-[2rem] bg-theme-surface-light dark:bg-theme-surface-dark border border-theme-border-light dark:border-theme-border-dark hover:border-brand-primary/30 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-3 text-theme-text-primary-light dark:text-theme-text-primary-dark">{feature.title}</h3>
                <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark text-sm leading-relaxed">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="pricing" className="py-24 px-6 bg-brand-primary/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-theme-text-primary-light dark:text-theme-text-primary-dark">Simple, Transparent <span className="text-brand-primary">Pricing</span></h2>
            <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark">Choose the plan that fits your trading journey.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {/* Free Plan */}
            <div className="p-8 rounded-[2rem] bg-theme-surface-light dark:bg-theme-surface-dark border border-theme-border-light dark:border-theme-border-dark flex flex-col">
              <h3 className="text-xl font-bold mb-2 text-theme-text-primary-light dark:text-theme-text-primary-dark">Free</h3>
              <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark text-sm mb-6">For beginners starting out.</p>
              <div className="text-4xl font-black mb-8 text-theme-text-primary-light dark:text-theme-text-primary-dark">$0<span className="text-lg text-theme-text-secondary-light dark:text-theme-text-secondary-dark font-normal">/mo</span></div>
              <div className="space-y-4 mb-8 flex-1">
                {["Manual Trade Logging", "Basic Performance Stats", "Limited AI Insights", "1 Trading Account"].map((f, i) => (
                  <div key={i} className="flex items-center gap-3 text-sm">
                    <CheckCircle2 className="w-4 h-4 text-theme-text-secondary-light dark:text-theme-text-secondary-dark" />
                    <span className="text-theme-text-primary-light dark:text-theme-text-primary-dark/80">{f}</span>
                  </div>
                ))}
              </div>
              <button 
                onClick={onGetStarted}
                className="w-full py-4 rounded-xl bg-theme-bg-light dark:bg-theme-bg-dark hover:bg-theme-border-light dark:hover:bg-theme-border-dark border border-theme-border-light dark:border-theme-border-dark font-bold transition-all text-theme-text-primary-light dark:text-theme-text-primary-dark"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="p-8 rounded-[2rem] bg-theme-surface-light dark:bg-theme-surface-dark border border-theme-border-light dark:border-theme-border-dark flex flex-col">
              ...
              <p className="text-theme-text-secondary-light dark:text-theme-text-secondary-dark text-sm mb-6">For professional fund managers.</p>
              <div className="text-4xl font-black mb-8 text-theme-text-primary-light dark:text-theme-text-primary-dark">$99<span className="text-lg text-theme-text-secondary-light dark:text-theme-text-secondary-dark font-normal">/mo</span></div>
              <div className="space-y-4 mb-8 flex-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-[2rem] bg-theme-surface-light dark:bg-theme-surface-dark border border-theme-border-light dark:border-theme-border-dark italic text-theme-text-secondary-light dark:text-theme-text-secondary-dark relative">
                ...
                <div className="flex items-center gap-3 not-italic">
                  <div className="w-10 h-10 rounded-full bg-theme-bg-light dark:bg-theme-bg-dark overflow-hidden">
                    <img src={`https://picsum.photos/seed/test${i}/100/100`} alt={t.name} referrerPolicy="no-referrer" />
                  </div>
                  <div>
                    <p className="font-bold text-theme-text-primary-light dark:text-theme-text-primary-dark text-sm">{t.name}</p>
                    <p className="text-xs text-theme-text-secondary-light dark:text-theme-text-secondary-dark">{t.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t border-theme-border-light dark:border-theme-border-dark text-center">
