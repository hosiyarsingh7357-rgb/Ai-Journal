              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
                ...
                <div className="text-center sm:text-left">
                  <div className="flex items-center gap-2">
                    {isEditingName ? (
                      <input
                        className="heading-2 bg-surface-muted border border-border rounded-lg px-2 py-1 outline-none focus:border-brand-primary/50"
                        value={fullName}
                  ...
                  <div className="mt-2 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-status-success/20 text-status-success border border-status-success/30 uppercase tracking-widest">Premium Tier</div>
                </div>
              </div>
            ...
            <div className="glass rounded-2xl shadow-premium overflow-hidden">
              <div className="p-4 lg:p-6 bg-surface-muted border-b border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-text-primary">MetaTrader Bridge</span>
                </div>
            ...
            <div className="divide-y divide-border">
              <div className="p-4 lg:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-text-primary">Account Session</h4>
                    <p className="text-xs text-text-secondary mt-1">Manage your active session and security preferences.</p>
                  </div>
                </div>
                <button 
                  onClick={signOut}
                  className="text-status-danger text-xs font-bold hover:underline flex items-center gap-2"
                >
              ...
              <div className="p-4 lg:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-text-primary">Two-Factor Authentication</h4>
                    <p className="text-xs text-text-secondary mt-1">Biometric and Authenticator App verification active.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-[10px] font-bold text-status-success uppercase tracking-wider">Active</span>
